...
const jobGrid = document.querySelector(".job-grid") || document.querySelector(".available-jobs");
...
jobGrid.appendChild(noResultsMessage); // Append at the end of job grid
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  if (!navSection) return; // Prevent error if navUserSection is missing
